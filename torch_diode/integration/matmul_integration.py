...
class MatmulIntegration(BaseIntegration):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        type_assert(
            model_pointers is None or isinstance(model_pointers, list),
            f"model_pointers must be list or None, got {type(model_pointers)}",
        )
        type_assert(
    ...
    def load_model(self, model_pointer: ModelPointer) -> Any:
        ...
        type_assert(
            isinstance(model_pointer, ModelPointer),
            f"model_pointer must be ModelPointer, got {type(model_pointer)}",
        )
        type_assert(
            hasattr(model_pointer, "full_path"),
            "model_pointer must have full_path property",
        )
        type_assert(
            hasattr(model_pointer, "model_name"),
            "model_pointer must have model_name attribute",
        )
    ...
    def register_model(self, model: Any, model_pointer: ModelPointer) -> bool:
        ...
        type_assert(
            hasattr(self, "enable_fallback"),
            "MatmulIntegration must have enable_fallback attribute",
        )
