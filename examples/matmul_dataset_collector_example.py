"""
Example script demonstrating how to use the MatmulDatasetCollector class.

This script shows how to collect matrix multiplication data with timing information
from PyTorch operations and store it in a Dataset, then convert it to a Table.
"""
...
def run_example():
    ...
    dataset_file = "matmul_dataset_example1.json"
    ...
    table_file = "matmul_table_example1.json"
    ...
    # Save the collected dataset to a file
    dataset_file = "matmul_dataset_example2.json"
    collector.save_to_file(dataset_file)
    print(f"Saved collected dataset to {dataset_file}")
    
    # Convert the dataset to a table and save it
    table_file = "matmul_table_example2.json"
    collector.save_table_to_file(table_file)
    print(f"Saved table to {table_file}")
    ...
    new_collector.load_from_file(dataset_file)
