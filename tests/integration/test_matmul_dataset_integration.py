...
class TestMatmulDatasetIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.temp_dataset_file = tempfile.NamedTemporaryFile(delete=False, suffix='.json')
        ...
        self.hardware_name = torch.cuda.get_device_name(0) if torch.cuda.is_available() else "cpu"
    ...
    def test_full_workflow(self):
        ...
        self._run_matrix_multiplications()
