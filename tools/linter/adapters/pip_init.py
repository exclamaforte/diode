...
def main() -> None:
    ...
    parser.add_argument("--dry-run", type=int, default=0, help="Don't actually install packages (0=install, 1=dry-run)")
    parser.add_argument("--no-black-binary", action="store_true", help="Don't use binary wheels for black")
